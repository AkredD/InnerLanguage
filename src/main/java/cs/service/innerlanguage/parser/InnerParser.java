...
public class InnerParser extends Parser {
	...
	public static class PlusEqStatemetContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InnerVisitor ) return ((InnerVisitor<? extends T>)visitor).visitPlusEqStatemet(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MinusEqStatemetContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InnerVisitor ) return ((InnerVisitor<? extends T>)visitor).visitMinusEqStatemet(this);
			else return visitor.visitChildren(this);
		}
	}
